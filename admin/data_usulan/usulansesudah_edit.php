<?php
session_start();
$judul = "Edit Data Usulan Sesudah";
...
$query = "SELECT * FROM usulan_sesudah WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['edit_usulan'])) {
        ...
        $query = "UPDATE usulan_sesusdah SET $setFields WHERE id = ?";
        $stmt = mysqli_prepare($connection, $query);
            ...
            <div class="col-12">
                <form class="card" method="POST">
                    ...
                    <div class="card-footer text-end">
                        <a href="usulan_sesudah.php" class="btn btn-secondary me-2">Kembali</a>
