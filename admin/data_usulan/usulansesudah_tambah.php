...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO usulan_sesudah ($columns) VALUES ($values)";
            ...
            <div class="col-12">
                <form class="card" method="POST">
                    <div class="card-header">
                        <h4 class="card-title">Form Tambah Data Usulan Sesudah</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <!-- Kolom 1 -->
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label>Pilih Ranting</label>
                                    <select name="kode_ranting" class="form-control" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="status" required>
                                        ...
                                        <option value="Aktif">Isolated</option>
                                        <option value="Non-Aktif">Interkoneksi</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="card-footer text-end">
                        <a href="isi_usulan.php" class="btn btn-secondary me-2">Kembali</a>
