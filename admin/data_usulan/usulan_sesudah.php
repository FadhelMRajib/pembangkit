    ...
    $judul = "Data Usulan Sesudah diubah";
    ...
    $count_query = "SELECT COUNT(*) AS total FROM usulan_sesudah WHERE 1=1";
    if (!empty($search)) {
                            ...
                            while ($usulan = mysqli_fetch_array($result)): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('admin/data_usulan/usulansesudah_edit.php?id=' . $usulan['id']) ?>" class="badge bg-primary">Edit</a>
